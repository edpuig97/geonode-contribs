...
from .pdf_helpers import generate_pdf
...
class ContextAware(AppAware):
    ...
    def fr_for_an(self, an, **kwargs):
        ...
        :type an: :py:class: .models.RiskAnalysis

        Returns list of :py:class: .models.FurtherResource
    ...
    def fr_for_dym(self, dym, **kwargs):
        ...
        :type dym: :py:class: .models.DymensionInfo
